...
interface PaymentRepository {
    fun buildPaymentUri(eventId: String, quantity: Int, unitPriceCents: Int, idempotencyKey: String): String

    fun parsePaymentCallback(callbackData: String): PaymentState

    suspend fun savePendingPurchase(idempotencyKey: String, eventId: String, quantity: Int, totalPriceCents: Int)
